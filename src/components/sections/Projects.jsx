            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="mb-24 relative">
                    ...
                    <h2 className="text-5xl md:text-8xl font-bold font-orbitron tracking-tighter text-dark mb-6 relative z-10">
                        ...
                        <span className="text-forest"><TextReveal delay={0.2}>WORKS</TextReveal></span>
                    </h2>
                    <motion.div
                        initial={{ width: 0 }}
                        ...
                        className="h-1 bg-amber relative z-10"
                    />
                </div>
                        ...
                        <div key={project.id} className="grid lg:grid-cols-12 gap-10 lg:gap-20">
                            ...
                            <div className="lg:col-span-4 lg:sticky lg:top-32 h-fit">
                                ...
                                >
                                    ...
                                    <h3 className="text-4xl md:text-5xl font-display font-bold leading-tight mb-4 group cursor-pointer hover:text-forest transition-colors">
                                        <TextReveal>{project.title}</TextReveal>
                                    </h3>

                                    <div className="flex items-center gap-2 text-stone uppercase tracking-widest text-xs font-bold mb-6">
                                    ...
                                    <p className="text-stone text-lg leading-relaxed mb-8 font-light">
                                        {project.description}
                                    </p>

                                    <div className="flex flex-wrap gap-2 mb-8">
                                        {project.tags.map(t => (
                                            <span key={t} className="text-xs font-mono border border-stone/20 px-2 py-1 text-stone/70">
                                                #{t}
                                            </span>
                                        ))}
                                    </div>

                                    <a href="#" className="inline-flex items-center gap-2 text-dark font-bold hover:text-amber transition-colors uppercase tracking-widest text-sm group">
                                        View Case Study
                                ...
                                {project.images.length > 4 && (
                                    <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
                                        {project.images.slice(4).map((img, i) => (
                                            <div key={i} className="w-64 aspect-square shrink-0 overflow-hidden bg-stone/10">
                ...
                <div className="mt-32 text-center">
                    <button className="px-10 py-4 border border-dark text-dark text-lg font-display font-bold hover:bg-dark hover:text-white transition-all duration-300">
                        VIEW ALL PROJECTS
                    </button>
                </div>
